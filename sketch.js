...
function setup() {
  ...
  trex = createSprite(50,displayHeight-520,20,50);
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-500,displayWidth,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth,displayHeight-530,10,40);
